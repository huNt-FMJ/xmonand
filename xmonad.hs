...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch a terminal
    [ ((modm,                   xK_i         ), spawn $ XMonad.terminal conf)

    -- launch dmenu
    , ((superKey,               xK_space     ), spawn "dmenu_run")
    ...
    -- Restart xmonad
    , ((modm .|. superKey, xK_q     ), spawn "xmonad --recompile; xmonad --restart")
...
--
main = do
  xmproc <- spawnPipe "xmobar -x0 /home/h/.xmonad/xmobar/xmobarrc"
